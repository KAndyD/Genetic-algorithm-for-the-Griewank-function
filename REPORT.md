...
Источник требований: предоставленный PDF Р. В. Душкина. Модель, синтетические данные,
операторы и иллюстрации созданы для этого комплекта. Реализация подготовлена заново;
сравнение на совпадения со всеми предыдущими работами не выполнялось.
